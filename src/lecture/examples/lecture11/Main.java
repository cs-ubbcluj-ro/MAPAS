...
public class Main {
    public static void main(String[] args) {
        TextFileRepository repoStudents = new TextFileRepository("src/lecture/examples/lecture11/Student.txt");
        TextFileRepository repoBooks = new TextFileRepository("src/lecture/examples/lecture11/Book.txt");
