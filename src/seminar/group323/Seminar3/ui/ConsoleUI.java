package seminar.group323.Seminar3.ui;
...
public class ConsoleUI {
    ...
    private void addMusic() {
        System.out.print("ID melodie: ");
        int id = scanner.nextInt();
        scanner.nextLine();
        System.out.print("Nume melodie: ");
        String name = scanner.nextLine();
        System.out.print("Pret: ");
        double price = scanner.nextDouble();
        scanner.nextLine();
    ...
    private void deleteAlbum() {
        System.out.print("ID album de sters: ");
        int id = scanner.nextInt();
    ...
    private void deleteMusic() {
        System.out.print("ID melodie de sters: ");
        int id = scanner.nextInt();
    ...
    private void updateAlbum() {
        System.out.print("ID album de actualizat: ");
        int id = scanner.nextInt();
        scanner.nextLine();
        Album existing = albumService.getAlbum(id);
        if (existing == null) {
            System.out.println("Album inexistent");
            return;
        }
